...
<!--
		...
		-->
                <span class="sbox_l"></span><span class="sbox"><input type="search" name="s" id="s" placeholder="Search..." autosave="applestyle_srch" results="5" /></span><span class="sbox_r" id="srch_clear"></span>
